...
class ProductMainWindowExt(QMainWindow,Ui_MainWindow):
    ...
    def import_from_excel(self):
        ...
        # Nhập danh mục từ Excel (Cate ID) vào listWidgetCategory (Widget 2)
        ...
        # Nhập sản phẩm từ Excel vào tableWidgetProduct (Widget 1)
        self.products = extool.import_products_EXCEL(filename_product)
        self.show_products_gui()  # Hiển thị sản phẩm lên Widget 1
