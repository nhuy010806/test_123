...
from ui.MainWindowEmployee2 import Ui_MainWindow


class MainWindowEmployeeExt2(Ui_MainWindow):
    def __init__(self):
        super().__init__()
    ...
    def xem_chi_tiet(self,sp):
        self.lineEditId.setText(sp.EmployeeId)
        self.lineEditName.setText(sp.EmployeeName)
        self.lineEditUserName.setText(sp.UserName)
        self.lineEditUserPassword.setText(sp.Password)
        self.selected_cate = sp
    ...
    def show_detail_employee(self):
        ...
        index = self.verticalLayout.currentRow()
