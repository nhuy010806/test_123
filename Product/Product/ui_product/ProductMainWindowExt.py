...
from Product.libs_product.DataConnector import DataConnector
from Product.libs_product.ExportTool import ExportTool
from Product.libs_product.JsonFileFactory import JsonFileFactory
from Product.models_product.Product import Product
from Product.ui_product.ProductMainWindow import Ui_MainWindow
...
class ProductMainWindowExt(Ui_MainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.movie = QMovie("../images_product/backgrproduct.gif")
    ...
    def export_to_txt(self):
        filename_product = "../dataset_product/products.txt"
        extool = ExportTool()
        extool.export_products_TXT(filename_product, self.products)

        filename_cate = "../../Category/dataset_cate/categories.txt"
    ...
    def export_to_csv(self):
        filename_product = "../dataset_product/products.csv"
        extool = ExportTool()
        extool.export_products_CSV(filename_product, self.products)

        filename_cate = "../../Category/dataset_cate/categories.csv"
    ...
    def export_to_json(self):
        filename_product = "../dataset_product/products.json"
        extool = ExportTool()
        extool.export_products_JSON(filename_product, self.products)

        filename_cate = "../../Category/dataset_cate/categories.json"
